...
export default {
  ...
  schema: [
    ...
    'types-as-schema src/restful-api-schema.ts --swagger static/swagger.json --swagger-base static/swagger-base.json --config ./generate-restful-api-declaration.ts',
